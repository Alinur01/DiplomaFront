            ...
            <div className="container">
                <nav className='footer__nav'>
                    ...
                    <ul className='footer__list footer__list2'>
                        ...
                        <li className='footer__item2'>Турусбекова 124, 8 этаж</li>
                    </ul>
                    <ul className='footer__list'>
                        <li className='footer__item'>Ссылки на:</li>
                        <li className='footer__item2'><a className='footer__social' href="https://wa.me/+996702965650">WhatsApp<BsWhatsapp/></a></li>
                        <li className='footer__item2'><a className='footer__social' href="https://www.instagram.com/">Instagram <BsInstagram/></a></li>
                        <li className='footer__item2'><a className='footer__social' href="https://t.me/alinur001">Telegram <BsTelegram/></a></li>
                        <li className='footer__item2'><a className='footer__social' href="#"> Tiktok<SiTiktok/></a></li>
                        <li className='footer__item2'><a className='footer__social' href="+996702965650">Позвонить <FiPhoneCall/></a></li>
                    </ul>
                </nav>
            </div>
        </footer>
